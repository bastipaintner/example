...
# Default-Stop:         0 1 6
# Short-Description:    Socket.io real time app
# Description:          Socket.io real time app for Subway Tube
### END INIT INFO
...
NAME="socketio"
NODE_BIN_DIR="/var/www/subway_tube"
NODE_PATH="$NODE_BIN_DIR/realtime/node_modules"
APPLICATION_PATH="$NODE_BIN_DIR/realtime/realtime.js"
PIDFILE="$NODE_BIN_DIR/tmp/pids/socketio.pid"
LOGFILE="$NODE_BIN_DIR/log/socketio.log"
MIN_UPTIME="5000"
SPIN_SLEEP_TIME="2000"
